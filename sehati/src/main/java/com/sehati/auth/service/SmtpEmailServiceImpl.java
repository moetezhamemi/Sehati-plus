...
public class SmtpEmailServiceImpl implements EmailService {
    ...
    public void sendVerificationEmail(String toEmail, String otpCode) {
        try {
            ...
            throw new RuntimeException("Erreur lors de l'envoi de l'e-mail de vérification: " + e.getMessage());
        }
    }
    ...
    public void sendPasswordResetEmail(String toEmail, String otpCode) {
        try {
            ...
            throw new RuntimeException("Erreur lors de l'envoi de l'e-mail de réinitialisation: " + e.getMessage());
        }
    }
}
